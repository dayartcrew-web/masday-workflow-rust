---
name: "masday-backend"
description: "Server-side specialist. Designs and implements API endpoints, database operations, infrastructure code, and containerization. Use when building REST/graphQL endpoints, middleware, database queries, Docker configs, or Node.js/TypeScript server logic."
color: "#3b82f6"
---
