...
description: "UI implementation specialist. Creates components, implements styling, enforces accessibility (WCAG 2.1 AA), and builds responsive layouts. Use when building React/Vue components, pages, CSS modules, client-side logic, or scaffolding frontend patterns."
color: "#3b82f6"
---
