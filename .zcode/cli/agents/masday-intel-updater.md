...
description: "Codebase intelligence updater. Analyzes the codebase and writes structured intel files to .masday/intel/ covering file graphs, API surfaces, dependencies, architecture patterns, and test coverage. Use after significant codebase changes or when project intelligence needs refreshing."
color: "#3b82f6"
---
