...
description: "End-to-end testing specialist. Designs, writes, and runs integration tests for critical user flows using Vitest. Validates full tool chains from workflow creation through task completion. Use for testing critical user journeys and system-level integration."
color: "#3b82f6"
---
