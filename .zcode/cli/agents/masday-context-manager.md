...
description: "Context preservation specialist for multi-agent handoffs. Captures decisions, builds context packs, tracks state changes, restores context on resume. Use before/after agent handoffs, when resuming interrupted workflows, or when preserving debugging state across sessions."
color: "#3b82f6"
---
