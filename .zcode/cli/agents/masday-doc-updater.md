...
description: "Documentation specialist. Generates and maintains technical documentation, API references, READMEs, and architecture docs. Verifies accuracy against the live codebase. Use when updating CLAUDE.md, README, API docs, or generating documentation from source code."
color: "#3b82f6"
---
