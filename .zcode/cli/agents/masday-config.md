---
name: "masday-config"
description: "Configuration management specialist. Manages environment variables, config files, secrets, TypeScript configs, and multi-environment setups with validation. Use when configuring .env files, settings.json, tsconfig, package.json scripts, or deployment configs."
color: "#3b82f6"
---
