...
| Mode | Example |
|------|---------|
| **Browser Review** | `/msd-frontend-review browser` |
| **Code Audit** | `/msd-frontend-review code` |
| **Full Review** | `/msd-frontend-review full` (browser + code) |
| **Compare vs Reference** | `/msd-frontend-review compare https://stripe.com` |
...
STEP 1: Save progress
  workflow_saveProgress({ workflow_id, task_id, agent_name: "msd-frontend-review", progress_note, evidence })
