...
SOURCE_DB="${1:-postgresql://postgres.gvjevnfmxiqpikvxiunc:pU335NIco29IwqsQ@aws-1-ap-southeast-2.pooler.supabase.com:5432/postgres}"
TARGET_DB="${2:-postgresql://postgres:postgres@localhost:54341/masday_workflow}"
